...
pub(crate) fn refresh(model: &AppRef) {
    match desktop_state() {
        Ok(state) => {
            ...
            let caldav_server_path = caldav_server_path(&state);
            model
                .ui
                .caldav_server_path
                .set_text(&short_value(caldav_server_path.as_deref()));
            ...
            model
                ...
                .set_sensitive(caldav_url.is_some());
            model
                .ui
        ...
        Err(error) => {
            ...
            model.ui.caldav_server_path.set_text("-");
