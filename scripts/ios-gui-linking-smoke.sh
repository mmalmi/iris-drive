...
OWNER_FIPS_PORT=""
OWNER_FIPS_OPEN_DISCOVERY_MAX_PENDING="${IRIS_DRIVE_IOS_FIPS_OPEN_DISCOVERY_MAX_PENDING:-8}"
SIM_APP_BASE_DIR=""
...
run_ui_test "IrisDriveIOSUITests/IrisDriveIOSUITests/testMyDriveShowsSyncStatusWithoutMobilePauseControls"
