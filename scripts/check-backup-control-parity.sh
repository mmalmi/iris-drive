...
require_contains ios/Sources/IrisDriveBackupViews.swift "Add Custom Target"
...
require_contains ios/Sources/IrisDriveBackupViews.swift "File Servers"
require_contains ios/Sources/IrisDriveBackupViews.swift "Add File Server"
require_contains ios/Sources/IrisDriveBackupViews.swift "Remove target"
require_contains ios/Sources/IrisDriveBackupViews.swift "Remove file server"
