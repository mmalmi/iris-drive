...
require_contains macos/Sources/IrisDriveControlPanel.swift 'Approve this device?'
require_contains macos/Sources/IrisDriveControlPanel.swift 'scanApprovalRequestQr'
