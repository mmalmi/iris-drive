...
require_file_contains macos/Sources/IrisDriveControlPanel.swift "Show join QR"
...
require_file_contains linux/src/setup.rs "Show join QR"
...
require_file_contains windows/MainWindow.xaml "Show join request"
