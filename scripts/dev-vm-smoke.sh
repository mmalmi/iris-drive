...
SYNC_WAIT_TIMEOUT="${IRIS_DRIVE_DEV_VM_SYNC_WAIT_TIMEOUT:-45}"
MACOS_PROVIDER_SYNC_WAIT_TIMEOUT="${IRIS_DRIVE_DEV_VM_MACOS_PROVIDER_SYNC_WAIT_TIMEOUT:-45}"
WINDOWS_PLACEHOLDER_DELETE_SYNC_WAIT_TIMEOUT="${IRIS_DRIVE_DEV_VM_WINDOWS_PLACEHOLDER_DELETE_SYNC_WAIT_TIMEOUT:-45}"
