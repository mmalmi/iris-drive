...
MAX_SYNC_WAIT_TIMEOUT="${IRIS_DRIVE_DEV_VM_MAX_SYNC_WAIT_TIMEOUT:-45}"
...
SYNC_WAIT_TIMEOUT="$(cap_wait_timeout "${IRIS_DRIVE_DEV_VM_SYNC_WAIT_TIMEOUT:-45}" "$MAX_SYNC_WAIT_TIMEOUT")"
MACOS_PROVIDER_SYNC_WAIT_TIMEOUT="$(cap_wait_timeout "${IRIS_DRIVE_DEV_VM_MACOS_PROVIDER_SYNC_WAIT_TIMEOUT:-45}" "$MAX_SYNC_WAIT_TIMEOUT")"
WINDOWS_PLACEHOLDER_DELETE_SYNC_WAIT_TIMEOUT="$(cap_wait_timeout "${IRIS_DRIVE_DEV_VM_WINDOWS_PLACEHOLDER_DELETE_SYNC_WAIT_TIMEOUT:-45}" "$MAX_SYNC_WAIT_TIMEOUT")"
