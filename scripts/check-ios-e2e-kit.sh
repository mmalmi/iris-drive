...
require_contains ios/Sources/IrisDriveRootView.swift "startJoinRequestIfNeeded"
...
require_contains ios/Sources/IrisDriveRootView.swift "Show join QR"
require_contains ios/Sources/IrisDriveMobileModel.swift '"type": "start_join_request"'
require_contains ios/Sources/IrisDriveRootView.swift "Request link or device key"
require_contains ios/Sources/IrisDriveRootView.swift "manualApprovalRequestDisclosure"
