...
require_contains windows/IrisDriveModels.cs 'SetupComplete = summary.HasValue && Bool(summary.Value, "setup_complete")'
require_contains windows/IrisDriveModels.cs 'AwaitingApproval = summary.HasValue && Bool(summary.Value, "awaiting_approval")'
