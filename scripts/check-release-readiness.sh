...
require_contains scripts/dev-vm-update-run.sh "IRIS_DRIVE_CASHU_SERVICE_ROOT"
require_contains scripts/dev-vm-update-run.sh "CASHU_SERVICE_BARE"
require_contains scripts/dev-vm-update-run.sh "cashu-service"
