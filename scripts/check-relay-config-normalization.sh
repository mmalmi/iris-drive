...
require_contains crates/iris-drive-core/src/relay_status.rs "pub fn normalized_relay_statuses_for_relays"
...
require_contains crates/iris-drive-app-core/src/ffi.rs "iris_drive_core::relay_status::normalized_relay_statuses_for_relays"
...
require_contains crates/iris-drive-cli/src/status.rs "iris_drive_core::relay_status::normalized_relay_statuses_for_relays"
...
require_absent crates/iris-drive-cli/src/status.rs "fn normalized_relay_statuses_for_relays"
require_absent crates/iris-drive-cli/src/status.rs "let Ok(url) = normalize_relay_url"
