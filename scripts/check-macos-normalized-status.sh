...
require_absent macos/Sources/IrisDriveStatus.swift 'publishedAppKeyRoots'
...
require_absent macos/Sources/IrisDriveMacApp.swift 'network["published_app_key_roots"]'
