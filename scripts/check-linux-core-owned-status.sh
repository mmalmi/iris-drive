...
require_contains linux/src/main.rs 'use iris_drive_app_core::{NativeAppAction, NativeAppState, UiState};'
...
require_contains linux/src/data.rs 'state.ui.online_device_count'
require_contains linux/src/data.rs 'state.ui.primary_status_label'
require_contains linux/src/render.rs 'peer.display_label'
require_contains linux/src/render.rs 'peer.role_label'
require_contains linux/src/render.rs 'peer.connection_label'
require_contains linux/src/render.rs 'peer.can_appoint_admin'
