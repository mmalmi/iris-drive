...
require_contains linux/src/data.rs 'find_string(summary_json(json), &["setup_state"])'
require_contains linux/src/data.rs 'find_string(summary_json(json), &["setup_label"])'
