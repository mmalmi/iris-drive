...
- Mounts must be virtual provider surfaces, not materialized normal folders. Use FileProvider, FUSE, WinFsp, SAF, or equivalent native virtual adapters over hashtree/provider roots; do not add user-visible materialized-folder fallbacks.
