...
const FIPS_DOWNLOAD_BEFORE_BLOSSOM_ATTEMPT_TIMEOUT_SECS: u64 = 5;
const STARTUP_NETWORK_TIMEOUT_SECS: u64 = 20;
const EVENT_BLOCK_PULL_TIMEOUT_SECS: u64 = 8;
const EVENT_BLOCK_PULL_RETRY_DELAYS: &[u64] = &[0, 1, 2, 4, 8, 12, 12, 12, 12, 12, 12, 30, 60];
...
const ROOT_UPDATE_THROTTLE_MS: u64 = 1_000;
