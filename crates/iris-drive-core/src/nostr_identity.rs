...
pub use nostr_identity::{
    ...
    NostrIdentityCapabilities, NostrIdentityEncryptedDeviceLabelsPayload, NostrIdentityError,
    NostrIdentityFacet, NostrIdentityFacetAcceptanceContent, NostrIdentityId,
